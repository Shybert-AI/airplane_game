...
class Settings():
    def __init__(self):
        ...
        self.background_image = pygame.image.load("image001/image_mm_01.jpg")
        #子弹设置
        self.bullet_width = 3
...
def run_deploy():
    ...
    while True:
        ...
        if stats.game_active:
            ...
            update_aliens(setting_1,stats,screen,ship,aliens,bullets)
...
def ship_hit(setting_1,stats,screen,ship,aliens,bullets):
    """响应被外星人撞到的飞船"""
    #将飞船数减1
...
def check_aliens_bottom(setting_1,stats,screen,ship,aliens,bullets):
    """检查是否有外星人到达屏幕底部"""
    ...
    for alien in aliens.sprites():
        if alien.rect.bottom >= screen_rect.bottom:
            ...
            #向飞船撞到一样处理
            ship_hit(setting_1,stats,screen,ship,aliens,bullets)
            break
...
def update_aliens(setting_1,stats,screen,ship,aliens,bullets):
    ...
    if pygame.sprite.spritecollideany(ship,aliens):
        ship_hit(setting_1,stats,screen,ship,aliens,bullets)
    #检查是否有外星人到达底部
    check_aliens_bottom(setting_1,stats,screen,ship,aliens,bullets)
...
class Button():
    ...
    def __init__(self,setting_1,screen,msg):
        ...
        #创建按钮的rect对象
        self.rect = pygame.Rect(0,400,self.width,self.height)
        self.rect.centerx = self.screen_rect.centerx
